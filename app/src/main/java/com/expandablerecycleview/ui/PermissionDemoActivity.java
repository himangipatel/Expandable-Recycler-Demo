...
public class PermissionDemoActivity extends AppCompatActivity  implements View.OnClickListener{
    ...
    public void onClick(@NonNull View v) {
        switch (v.getId()) {
            case R.id.button_camera:
                ...
                PermissionDemoActivityPermissionsDispatcher.showCameraWithCheck(this);
                break;
            case R.id.button_contacts:
                // NOTE: delegate the permission handling to generated method
                PermissionDemoActivityPermissionsDispatcher.showContactsWithCheck(this);
                break;
        }
    }
    ...
    void showCamera() {
        ...
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.sample_content_fragment,new SkimFragment())
